...
function Contact() {
  return <><PageIntro eyebrow="Let’s make something" title={<>Have a project<br /><em>in mind?</em></>} text="Tell me a little about what you’re working on and I’ll get back to you with the next step." /><section className="section-shell contact-layout"><div className="contact-info"><p className="eyebrow">Reach out directly</p><h2>Good conversations<br />make great work.</h2><a href="mailto:hadi23malik" className="contact-link"><Mail size={20} /><span><small>Email me</small>hadi23malik</span><ArrowRight size={18} /></a><a href="https://wa.me/923238400840" target="_blank" rel="noreferrer" className="contact-link"><MessageCircle size={20} /><span><small>WhatsApp</small>+92 323 8400840</span><ArrowRight size={18} /></a><div className="contact-note"><span className="status-dot" /><p>Usually replies within 24 hours<br /><small>Monday — Saturday · 10am — 7pm</small></p></div></div><form className="contact-form" onSubmit={(event) => { event.preventDefault(); window.open('https://wa.me/923238400840', '_blank'); }}><label>Your name<input required placeholder="What should I call you?" /></label><label>Your email<input required type="email" placeholder="Where can I reach you?" /></label><label>Tell me about your project<textarea required rows={4} placeholder="A few words about what you need..." /></label><button className="button button-primary" type="submit">Send enquiry <ArrowRight size={16} /></button></form></section><section className="pricing-section section-shell"><div><p className="eyebrow">Simple starting points</p><h2>Choose your<br /><em>starting point.</em></h2><div className="sale-badge"><span className="sale-dot" /> BIG SALE</div></div><div className="pricing-grid"><div className="price-card"><span>01</span><h3>Essentials</h3><p>Creating 1 design of resume.</p><div className="price-row"><span className="price-old">Rs 2,500</span><span className="price-new">Rs 980</span></div><button onClick={() => goTo('contact')}>Buy now <ArrowRight size={16} /></button></div><div className="price-card featured-price"><span>02 · Most popular</span><h3>Complete</h3><p>Creating portfolio or resume.</p><div className="price-row"><span className="price-old">Rs 3,500</span><span className="price-new">Rs 1,480</span></div><button onClick={() => goTo('contact')}>Buy now <ArrowRight size={16} /></button></div><div className="price-card"><span>03</span><h3>Photo Editing</h3><p>Professional photo editing & retouching.</p><div className="price-row"><span className="price-old">Rs 500</span><span className="price-new">Rs 280</span></div><button onClick={() => goTo('contact')}>Buy now <ArrowRight size={16} /></button></div><div className="price-card"><span>04</span><h3>Video Editing</h3><p>Short-form video editing & content.</p><div className="price-row"><span className="price-old">Rs 1,000</span><span className="price-new">Rs 690</span></div><button onClick={() => goTo('contact')}>Buy now <ArrowRight size={16} /></button></div><div className="price-card price-card-wide"><span>05</span><h3>Custom</h3><p>Word or Excel work, description for big projects on Adobe Photoshop, Adobe Illustrator, Excel, Word or PowerPoint work — contact us on WhatsApp.</p><button onClick={() => goTo('contact')}>Contact on WhatsApp <ArrowRight size={16} /></button></div></div><div className="pricing-note"><strong>Important note:</strong> To buy these starting points, contact <b>03238400840</b> and send money on Easypaisa <b>+92 323 8400840</b>.</div></section></>;
}
...
function IntroOverlay({ onDone }: { onDone: () => void }) {
  ...
  return (
    <div className="intro-overlay">
      <div className="intro-stage intro-sale">
        <h1 className="intro-sale-text">BIGGEST SALE IS LIVE</h1>
      </div>
      <div className="intro-stage intro-plane-stage">
        <div className="intro-plane">
          <Plane size={42} />
        </div>
        <div className="intro-plane-name">
          <span>Hadi Malik</span>
        </div>
        <div className="intro-plane-trail" />
      </div>
      <div className="intro-stage intro-portrait-stage">
        <div className="intro-portrait">
          <img src="/images/hadi.jpg" alt="Hadi Malik" />
          <h2 className="intro-portrait-name">Hadi Malik</h2>
        </div>
      </div>
    </div>
  );
